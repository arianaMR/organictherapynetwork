...
### `middleware.createListener(runner: function(action: object, dispatch: function)): object`
...
## `toolset.addRule(rule: string|RegExp, modifier: function(action: object): object): toolset`
...
## `toolset.addRules(rules: array<array<rule: string|Regexp, modifier: function>>): toolset`
