...
The only export of the package is a function, that returns a fresh and 
consistent middleware that is 100 % compatible to redux.

### `middleware.createListener(function(action: object, dispatch: function)): object`
